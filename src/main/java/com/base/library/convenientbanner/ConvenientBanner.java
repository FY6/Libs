package com.base.library.convenientbanner;
...
import com.base.library.convenientbanner.adapter.CBPageAdapter;
import com.base.library.convenientbanner.holder.CBViewHolderCreator;
import com.base.library.convenientbanner.listener.CBPageChangeListener;
import com.base.library.convenientbanner.listener.OnItemClickListener;
import com.base.library.convenientbanner.view.CBLoopViewPager;
...
public class ConvenientBanner<T> extends LinearLayout {
    ...
    public ConvenientBanner(Context context, AttributeSet attrs) {
        ...
        slip_bottom = a.getDimension(R.styleable.ConvenientBanner_slip_bottom, 10);
        a.recycle();
        init(context);
    }
    ...
    private void init(Context context) {
        ...
        RelativeLayout.LayoutParams lp = (RelativeLayout.LayoutParams) loPageTurningPoint.getLayoutParams();
        lp.bottomMargin = (int) slip_bottom;
     ...
     * 指示器的方向
     *
     * @param align 三个方向：居左 （RelativeLayout.ALIGN_PARENT_LEFT），居中 （RelativeLayout.CENTER_HORIZONTAL），居右 （RelativeLayout
     *              .ALIGN_PARENT_RIGHT）
     * @return
     */
    public ConvenientBanner setPageIndicatorAlign(PageIndicatorAlign align) {
        RelativeLayout.LayoutParams layoutParams = (RelativeLayout.LayoutParams) loPageTurningPoint.getLayoutParams();
        layoutParams.addRule(RelativeLayout.ALIGN_PARENT_LEFT, align == PageIndicatorAlign.ALIGN_PARENT_LEFT ? RelativeLayout
                .TRUE : 0);
        layoutParams.addRule(RelativeLayout.ALIGN_PARENT_RIGHT, align == PageIndicatorAlign.ALIGN_PARENT_RIGHT ? RelativeLayout
                .TRUE : 0);
        layoutParams.addRule(RelativeLayout.CENTER_HORIZONTAL, align == PageIndicatorAlign.CENTER_HORIZONTAL ? RelativeLayout
                .TRUE : 0);
