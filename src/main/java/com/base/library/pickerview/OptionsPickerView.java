package com.base.library.pickerview;
...
import com.base.library.pickerview.lib.WheelView;
import com.base.library.pickerview.listener.CustomListener;
import com.base.library.pickerview.view.BasePickerView;
import com.base.library.pickerview.view.WheelOptions;
...
public class OptionsPickerView<T> extends BasePickerView implements View.OnClickListener {
    ...
    private void initView(Context context) {
        ...
        if (customListener == null) {
            ...
            //设置文字
            btnSubmit.setText(TextUtils.isEmpty(Str_Submit) ? context.getResources().getString(R.string.pickerview_submit) :
                    Str_Submit);
            btnCancel.setText(TextUtils.isEmpty(Str_Cancel) ? context.getResources().getString(R.string.pickerview_cancel) :
                    Str_Cancel);
