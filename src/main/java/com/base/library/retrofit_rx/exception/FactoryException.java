...
public class FactoryException {
    ...
    private static final String HttpException_MSG = "网络服务器开小差了";
    private static final String ConnectException_MSG = "服务器开小差了";
    ...
    public static ApiException analysisExcetpion(Throwable e) {
        ...
        if (e instanceof HttpException) {
            ...
            apiException.setCode(apiException.getCode());
