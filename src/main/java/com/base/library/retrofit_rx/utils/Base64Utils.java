 ...
 *
 * the Base64Utils encoding can be represented by
...
public class Base64Utils {
    ...
    public final static byte[] _encode(byte[] byteData) {
        ...
        /*
         * Use the encoded data as indexes into the Base64Utils alphabet. (The Base64Utils
    ...
    public final static byte[] _decode(byte[] byteData) throws IllegalArgumentException {
        ...
        /*
         * Convert from Base64Utils alphabet to encoded data (The Base64Utils alphabet is
         ...
         * filler, as per Base64Utils spec. stop before potential buffer overun on
        ...
        if (iSrcIdx < reviSrcIdx) {
             ...
             */
                ...
                throw new IllegalArgumentException("Warning: 1 input bytes left to process. This was not Base64Utils input");
            }
        }
        return byteDest;
    }
