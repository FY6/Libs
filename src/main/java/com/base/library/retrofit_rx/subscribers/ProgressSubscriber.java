...
import com.base.library.retrofit_rx.dialog.LoadingDailog;
...
public class ProgressSubscriber<T> extends Subscriber<T> {
    ...
    private void errorDo(Throwable e) {
        ...
        AbLogUtil.e("RxRetrofit", "e--->" + apiException.getDisplayMessage());
    }
